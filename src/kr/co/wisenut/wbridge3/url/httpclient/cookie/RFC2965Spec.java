...
import kr.co.wisenut.wbridge3.url.httpclient.HeaderElement;
import kr.co.wisenut.wbridge3.url.httpclient.NameValuePair;
import kr.co.wisenut.wbridge3.url.httpclient.util.ParameterFormatter;
...
public class RFC2965Spec extends CookieSpecBase implements CookieVersionSupport {
    ...
    */
    ...
    /**
     * @see #parse(String, int, String, boolean, kr.co.wisenut.wbridge3.url.httpclient.Header)
     */
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} properties.
     *
     * @param attribute {@link kr.co.wisenut.wbridge3.url.httpclient.NameValuePair} cookie attribute from the
     * <tt>Set-Cookie2</tt> header.
     * @param cookie {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} to be updated
     * @throws MalformedCookieException if an exception occurs during parsing
     */
...
/*            if (LOG.isDebugEnabled())
    ...
    /**
     * Performs RFC 2965 compliant {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} validation
     *
     * @param host the host from which the {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} was received
     * @param port the port from which the {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} was received
     * @param path the path from which the {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} was received
     * @param secure <tt>true</tt> when the {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} was received using a
     * secure connection
     ...
     * defined in RFC 2965
     * @param cookie a {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} to be formatted as string
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie}s suitable for
     * sending in a <tt>"Cookie"</tt> header
     * @param cookies an array of {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie}s to be formatted
...
//                        LOG.warn("Invalid cookie state: port not specified");
  ...
  private class Cookie2MaxageAttributeHandler
      ...
      /**
       * @see CookieAttributeHandler#match(kr.co.wisenut.wbridge3.url.httpclient.Cookie, String)
       */
      public boolean match(final Cookie cookie, final CookieOrigin origin) {
          return true;
      }
