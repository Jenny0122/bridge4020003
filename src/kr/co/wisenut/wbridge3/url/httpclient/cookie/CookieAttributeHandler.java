...
public interface CookieAttributeHandler {
   ...
   * {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} property.
   *
   ...
   *
   * @param cookie {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} to validate
   ...
   *
   * @param cookie {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie} to match
