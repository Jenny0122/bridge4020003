/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/HttpMethodBase.java,v 1.1.1.1 2009/03/10 07:02:40 wisenut Exp $
 * $Revision: 1.1.1.1 $
...
import kr.co.wisenut.wbridge3.url.httpclient.auth.AuthState;
import kr.co.wisenut.wbridge3.url.httpclient.cookie.CookiePolicy;
import kr.co.wisenut.wbridge3.url.httpclient.cookie.CookieSpec;
import kr.co.wisenut.wbridge3.url.httpclient.cookie.CookieVersionSupport;
import kr.co.wisenut.wbridge3.url.httpclient.cookie.MalformedCookieException;
import kr.co.wisenut.wbridge3.url.httpclient.params.HttpMethodParams;
import kr.co.wisenut.wbridge3.url.httpclient.protocol.Protocol;
import kr.co.wisenut.wbridge3.url.httpclient.util.EncodingUtil;
 ...
 *
 * @version $Revision: 1.1.1.1 $ $Date: 2009/03/10 07:02:40 $
 */
...
//    private static final Log LOG = LogFactory.getLog(HttpMethodBase.class);
    ...
    * a recoverable exception. */
     ...
     * 
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getURI()
     */
...
//            //LOG.debug("null header value ignored");
    ...
    /**
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getRequestHeaders(java.lang.String)
     */
    ...
    /**
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getResponseHeaders(java.lang.String)
     * 
     * @since 3.0
     */
...
//            LOG.warn("Multiple content-length headers detected");
     ...
     * response body.
     */
    public byte[] getResponseBody(String encodingType) throws IOException {
        ...
        if (this.responseBody == null) {
            ...
            }else if(encodingType != null && encodingType.equals("deflate")) {
    ...
    public String getResponseBodyAsString() throws IOException {
    	return getResponseBodyAsString(null);
    }
     ...
     * response body.
     */
    public String getResponseBodyAsString(String encoding) throws IOException {
        byte[] rawdata = null;
        if (responseAvailable()) {
            rawdata = getResponseBody(encoding);
        }
        if (rawdata != null) {
     ...
     * 
     * @deprecated Use {@link kr.co.wisenut.wbridge3.url.httpclient.params.HttpParams#setParameter(String, Object)}
