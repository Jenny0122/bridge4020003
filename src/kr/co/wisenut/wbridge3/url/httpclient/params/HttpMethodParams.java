/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/params/HttpMethodParams.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 * $Revision: 1.1.1.1 $
 ...
 * {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods}. Protocol
...
//    private static final Log LOG = LogFactory.getLog(HttpMethodParams.class);
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods}.
     * <p>
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods} per
     * default.
     * <p>
    ...
    /**
     * Defines whether {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods} should
     * reject ambiguous {@link kr.co.wisenut.wbridge3.url.httpclient.StatusLine HTTP status line}.
     * <p>
    ...
    /**
     * Defines whether {@link kr.co.wisenut.wbridge3.url.httpclient.Cookie cookies} should be put on
     * a single {@link kr.co.wisenut.wbridge3.url.httpclient.Header response header}.
     * <p>
     * This parameter expects a value of type {@link Boolean}.
     * </p>
     */
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.methods.HeadMethod} should be rejected.
     * <p>
     * This parameter expects a value of type {@link Boolean}.
     * </p>
     */
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.methods.HeadMethod HEAD method} from a
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.methods.ExpectContinueMethod
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.Credentials}. If not defined then the
     ...
     * <p>
     * This parameter expects a value of type {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethodRetryHandler}.
     * </p>
     */ 
     ...
     * </p>
     * @see kr.co.wisenut.wbridge3.url.httpclient.methods.multipart.MultipartRequestEntity
     */
...
//            LOG.warn("Default content charset not configured, using ISO-8859-1");
    ...
    /**
     * Returns the charset to be used for {@link kr.co.wisenut.wbridge3.url.httpclient.Credentials}. If
...
//            //LOG.debug("Credential charset not configured, using HTTP element charset");
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods} that
    ...
    /**
     * Makes the {@link kr.co.wisenut.wbridge3.url.httpclient.HttpMethod HTTP methods}
