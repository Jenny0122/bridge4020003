/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/auth/NTLM.java,v 1.1.1.1 2009/03/10 07:02:41 wisenut Exp $
 * $Revision: 1.1.1.1 $
 ...
 *
 * @version $Revision: 1.1.1.1 $ $Date: 2009/03/10 07:02:41 $
 * @since 3.0
 */
final class NTLM {
    ...
    private String getResponse() {
        ...
        return EncodingUtil.getAsciiString(resp);
    }
    ...
    public byte[] parseType2Message(String message) {
        ...
        byte[] msg = EncodingUtil.getBytes(message, DEFAULT_CHARSET);
