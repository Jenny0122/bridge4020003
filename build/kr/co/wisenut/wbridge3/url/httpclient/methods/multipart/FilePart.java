/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/methods/multipart/FilePart.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 * $Revision: 1.1.1.1 $
...
//    private static final Log LOG = LogFactory.getLog(FilePart.class);
     ...
     * @param out The output stream.
     * @throws IOException if an IO problem occurs.
     * @see kr.co.wisenut.wbridge3.url.httpclient.methods.multipart.Part#sendData(OutputStream)
     */
