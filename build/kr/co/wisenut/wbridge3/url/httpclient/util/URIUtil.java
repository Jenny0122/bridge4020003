/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/util/URIUtil.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 * $Revision: 1.1.1.1 $
...
import kr.co.wisenut.wbridge3.url.httpclient.URI;
import kr.co.wisenut.wbridge3.url.httpclient.URIException;

/**
 * The URI escape and character encoding and decoding utility.
 * It's compatible with {@link kr.co.wisenut.wbridge3.url.httpclient.HttpURL} rather
 * than {@link kr.co.wisenut.wbridge3.url.httpclient.URI}.
 *
 * @author <a href="mailto:jericho@apache.org">Sung-Gu</a>
 * @version $Revision: 1.1.1.1 $ $Date: 2002/03/14 15:14:01 
 */
public class URIUtil {
    ...
    public static String encode(String unescaped, BitSet allowed,
        ...
        byte[] rawdata = EncodingUtil.getBytes(unescaped, charset);
    ...
    public static String decode(String escaped) throws URIException {
        byte[] rawdata = EncodingUtil.getAsciiBytes(escaped);
