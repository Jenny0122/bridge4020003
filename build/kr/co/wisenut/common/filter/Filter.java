...
public abstract class Filter implements IFilter {
    ...
    public boolean filteringFile(String sourceFile, String targetFile, String condition) {
        return filteringFile(sourceFile, targetFile, condition, "snf_exe", "", "utf-8");
    }
    ...
    public boolean filteringFile(String sourceFile, String targetFile, String condition,
        ...
        if(isGul(sourceFile)) { //use docfilter
            ...
            if(filter.equalsIgnoreCase("all") || filter.equalsIgnoreCase("sn3f")) filter = "snf_exe";
        ...
        } else if(isBwp(sourceFile)) { // 蹂대씪�썙�뱶 �궗�슜
    ...
    public static void main(String[] args) {
    	...
    	String[] cmd = null;
    	 if(filterargs != null && filterargs.length > 1) {
	//    	String[] cmd = new String[] {arg, "C:\\KM_DOWN\\PT Q-Library 李⑹닔 寃��넗 寃곌낵v1.0.pptx","C:\\oletest.txt"};
	    	cmd = new String[filterargs.length + 2];
	    	for(int i=0;i<filterargs.length;i++){
	    		cmd[i] = filterargs[i];
	    	}
	    	cmd[filterargs.length] = "C:\\KM_DOWN\\PT Q-Library 李⑹닔 寃��넗 寃곌낵v1.0.pptx";
