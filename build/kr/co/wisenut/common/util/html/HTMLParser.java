...
//            stringValue = new String (pagepart, startindex, l, "ISO-8859-1");
            // Tag Value 媛믪쓣 ���옣�븷�븣 �븳湲��씠 源⑥�湲� �븣臾몄뿉 String �쓣 �깮�꽦 �븷�븣 UTF-8 濡� �깮�꽦
        ...
        while (index < length) {
            ...
            switch (pagepart[index++]) {
                ...
                case (int)'>':
                    return nextToken = MT;
                case (int)'=':
                	if(index < length && pagepart[index] == '=') { //2020.5 bug fix
...
//                        return nextToken = EQUALS;
    ...
    // 遺꾩꽍�맂 HTML �뿉�꽌 �쑀�슚�븳 Token �씤吏� �솗�씤�븯�뿬 諛곗옱猷곗뿉 �룷�븿�맂 token�� �젣�쇅�븳�떎.
