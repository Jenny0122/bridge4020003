...
public class UnZip {
    ...
    public List unZipOld(String srcFilePath, String targetDir) throws IOException {
        FileUtil.makeDir(targetDir);    // �븬異뺥빐�젣 �븯湲� �쐞�븳 �뤃�뜑瑜� �깮�꽦�븳�떎
...
//        Enumeration<ZipArchiveEntry> lenum;
        ...
        try {
            ...
            FileUtil.makeDir(unZipDir);    // �븬異뺥빐�젣 �븯湲� �쐞�븳 �뤃�뜑瑜� �깮�꽦�븳�떎
...
//                }
            ...
            Log2.debug("zip file not found (" + zipFile.getPath() + ")", 3);
        }
        return zipList;
    }

    /**
     * zip �뙆�씪�쓣 �빐�젣�븯怨� �빐�젣�븳 zip �뙆�씪 �븞�뿉 �떎瑜� zip �뙆�씪�씠 議댁옱�븯�뒗寃쎌슦 �옱洹��쟻�쑝濡� �빐�젣�븳�떎.
     * @param zipFilePath
     * @param unZipDir
     * @return
     * @throws IOException
    ...
    private List getAllFile(File dir) {
        ...
        for(int i=0; i < listFiles.length; i++) {
            ...
            if(!listFiles[i].delete()) {
                Log2.debug("UnZip::getAllFile() delete fail : " + listFiles[i], 3);
                int count = 0;
                while (count < 10) {
                    try {
                        Thread.sleep(1000);
...
//        }
        ...
        unZip.unZipAll("c:/Temp/softcamp/kms6638083808517703817 - 蹂듭궗蹂�.zip", "c:/Temp/unZipAll");
