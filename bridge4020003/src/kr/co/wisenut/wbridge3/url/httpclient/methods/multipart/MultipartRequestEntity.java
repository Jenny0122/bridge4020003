/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/methods/multipart/MultipartRequestEntity.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 * $Revision: 1.1.1.1 $
 ...
 * {@link kr.co.wisenut.wbridge3.url.httpclient.methods.PostMethod post method} to provide
...
//    private static final Log log = LogFactory.getLog(MultipartRequestEntity.class);
     ...
     * @see kr.co.wisenut.wbridge3.url.httpclient.methods.RequestEntity#isRepeatable()
     */
    ...
    /* (non-Javadoc)
     * @see kr.co.wisenut.wbridge3.url.httpclient.methods.RequestEntity#writeRequest(java.io.OutputStream)
     */
    ...
    /* (non-Javadoc)
     * @see kr.co.wisenut.wbridge3.url.httpclient.methods.RequestEntity#getContentLength()
     */
