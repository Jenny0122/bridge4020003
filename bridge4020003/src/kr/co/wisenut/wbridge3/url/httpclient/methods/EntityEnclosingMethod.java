/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/methods/EntityEnclosingMethod.java,v 1.1.1.1 2009/03/10 07:02:41 wisenut Exp $
 * $Revision: 1.1.1.1 $
...
import kr.co.wisenut.wbridge3.url.httpclient.ChunkedOutputStream;
...
//    private static final Log LOG = LogFactory.getLog(EntityEnclosingMethod.class);
     ...
     * {@link kr.co.wisenut.wbridge3.url.httpclient.HttpConstants#DEFAULT_CONTENT_CHARSET default}
