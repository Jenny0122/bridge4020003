/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/MultiThreadedHttpConnectionManager.java,v 1.1.1.1 2009/03/10 07:02:40 wisenut Exp $
 * $Revision: 1.1.1.1 $
...
import kr.co.wisenut.wbridge3.url.httpclient.params.HttpConnectionManagerParams;
...
import kr.co.wisenut.wbridge3.url.httpclient.util.IdleConnectionHandler;
...
//    private static final Log LOG = LogFactory.getLog(MultiThreadedHttpConnectionManager.class);
    ...
    private static class HttpConnectionAdapter extends HttpConnection {
        ...
        /* (non-Javadoc)
         * @see kr.co.wisenut.wbridge3.url.httpclient.HttpConnection#print(java.lang.String, java.lang.String)
         */
        ...
        /* (non-Javadoc)
         * @see kr.co.wisenut.wbridge3.url.httpclient.HttpConnection#printLine(java.lang.String, java.lang.String)
         */
        ...
        /* (non-Javadoc)
         * @see kr.co.wisenut.wbridge3.url.httpclient.HttpConnection#setSocketTimeout(int)
         */
