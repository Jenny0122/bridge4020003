...
public class Config {
    ...
    private HashMap ftServerConfMap;
    private RunTimeArgs m_args;

    public HashMap getFtServerConfMap() {
        return ftServerConfMap;
    }

    public void setFtServerConfMap(HashMap ftServerConfMap) {
        this.ftServerConfMap = ftServerConfMap;
    }
    ...
    public String getSf1Home() {
        return m_args.getSf1_home();
    }
