/*
 * $Header: /home/cvs/Bridge/Standard/v3.8.1/WBridge/src/kr/co/wisenut/wbridge3/url/httpclient/util/HttpURLConnection.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 * $Revision: 1.1.1.1 $
 ...
 * @since 2.0
 *
 * @version $Id: HttpURLConnection.java,v 1.1.1.1 2009/03/10 07:02:42 wisenut Exp $
 */
...
//    private static final Log LOG = LogFactory.getLog(HttpURLConnection.class);
     ...
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getResponseBodyAsStream()
     */
     ...
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getStatusCode()
     */
     ...
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getStatusText()
     */
     ...
     * @see kr.co.wisenut.wbridge3.url.httpclient.HttpMethod#getResponseHeaders()
     */
